...
//尝试开始session
  ...
  */
  ...
  function create($openid="")
  {
    ...
    //往图片上写验证码
    $img = $this->writeCheckCodeToImage();

    if (!file_exists("./public/uploads/WePictures/")) {
        mkdir ("./public/uploads/WePictures/",0777,true);
    }

    $url = "./public/uploads/WePictures/".md5(microtime(true)).".png";//图片路径
    imagepng($this->checkimage,$url);
    imagedestroy($this->checkimage);

    Cache::set($openid,$this->checkcode);
